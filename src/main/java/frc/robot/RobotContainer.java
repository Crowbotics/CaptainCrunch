...
public class RobotContainer {
  ...
  // Replace with CommandPS4Controller or CommandGenericHID if needed
  private final CommandGenericHID m_driverGamepad =
      new CommandGenericHID(OperatorConstants.kDriverControllerPort);
  private final CommandGenericHID m_auxGamepad =
